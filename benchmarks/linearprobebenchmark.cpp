...
void demorandom(const uint64_t howmany, const float loadfactor, const int repeat) {
    ...
    ForEachT<BitMixing64Pack,ClBitMixing64Pack, Murmur64Pack, CRC32_64Pack, Cyclic64Pack, Zobrist64Pack,  MultiplyShift64Pack, ClLinear64Pack, ClQuadratic64Pack, ClCubic64Pack, ClQuartic64Pack,
